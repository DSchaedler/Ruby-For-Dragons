...
`Variables` are containers that we use to hold information. In order to make a `variable`, we first have to pick a name. A `variable`'s name should describe what it is going to be used for.
